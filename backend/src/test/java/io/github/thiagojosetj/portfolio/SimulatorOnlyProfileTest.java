...
class SimulatorOnlyProfileTest {
  ...
  @Test
  void startsWithoutPersistenceBeans() throws Exception {
  ...
  @Test
  void simulatesContributionWithoutDatabase() throws Exception {
    mockMvc
        .perform(
            post("/api/v1/allocation-simulations/contributions")
                ...
                .content(
                    ...
                    """))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.currentTotal").value("100.00"))
  ...
  @Test
  void keepsValidationActiveWithoutDatabase() throws Exception {
    mockMvc
        .perform(
            post("/api/v1/allocation-simulations/contributions")
                .contentType(MediaType.APPLICATION_JSON)
